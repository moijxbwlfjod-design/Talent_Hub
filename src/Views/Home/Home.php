...
<header class="sticky top-0 z-50 bg-gradient-to-r from-gray-900 to-gray-800 border-b border-gray-700">
    <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href="login" class="hidden sm:block px-5 py-2.5 text-gray-300 font-medium text-sm hover:text-white transition duration-300">Log In</a>
            <a href="register" class="px-6 py-2.5 bg-blue-600 text-white font-medium text-sm rounded-lg hover:bg-blue-700 transition duration-300 shadow-sm hover:shadow-md">Sign Up</a>
        </div>
    </div>
</header>
